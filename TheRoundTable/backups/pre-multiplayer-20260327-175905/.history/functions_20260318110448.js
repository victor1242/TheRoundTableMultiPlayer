...
function logInPlayers() {
  ...
  game.players[0].aiPlayer = true;
  game.players[1].aiPlayer = true;
  game.players[2].aiPlayer = true;
...
function dealNewRoundCards() {
    ...
    displayCardBack("<div class="card-piles">
  <div class="pile">
    <img src="cards/back.png" alt="Deck" class="card-img deck-img">
    <div class="pile-label">Deck</div>
    <div class="pile-count" id="deck-count">106</div>
  </div>
  <div class="pile">
    <img src="cards/faceup.png" alt="Discard" class="card-img discard-img">
    <div class="pile-label">Discard</div>
    <div class="pile-count" id="discard-count">1</div>
  </div>
</div>");
...
function updateDisplay() {
  /*
    ...
    if (deckCountEl) deckCountEl.innerText = deckCount;
    if (discardCountEl) discardCountEl  .innerText = discardCount;
    */
    const deckCardsEl = document.getElementById('deck');
    const discardCardsEl = document.getElementById('discard');
    if (deckCardsEl) deckCardsEl.innerText = `${game.deck.cards.length}`;
    if (discardCardsEl) discardCardsEl.innerText = `${game.discardPile.length}`;  
      }
...
// Example: Draw a card after 2 seconds
