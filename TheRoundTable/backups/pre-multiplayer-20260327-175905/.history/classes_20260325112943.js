...
class GameState {
  constructor() {
    ...
    this.optGoingOutBonus = true; // Bonus points for going out 
    ...
    this.optUseIcons = true;
    this.handCardListenersBound = false;
    this.debugToggleBound = false;
    this.aiPauseButtonBound = false;
    this.aiAutoPlayEnabled = false;
    this.aiAutoPlayAnimationId = null;
    this.aiAutoPlayPaused = false;
    this.aiAutoPlaySpeed = 1;
    this.aiManualStepMode = false;
    this.aiPendingStep = false;
    this.aiPendingAdvance = false;
    this.aiAutoPlayAutoPaused = false;
    this.aiVisibilityHandlerBound = false 
    this.DEBUG = false;
    this.TRACE = false;
    this.meldingColour = "6px solid red";
    this.lastRound = 11;
