...
localStorage.setItem("newgameSaveData", saveString);
console.log("Saved game state string:", saveString);
showMessage("Saved game state string:", saveString);

const storedSaveString =                           localStorage.getItem("newgameSaveData");
if (storedSaveString) {
