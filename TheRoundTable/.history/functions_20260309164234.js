...
function showMessage(msg) {
  const filterValidateMeld = "[validateMeld]";  
  if (DEBUG) alert(msg);
    {
    if (msg.substring(0,filterValidateMeld.length-1) !=  filterValidateMeld )console.log(msg);
  }
}
...
function validateMeld(group) {
 ...
 function advanceTurn(options = {}) {
  ...
  setPlayerDrawMode();
  if (game.currentPlayer.aiPlayer) aiTakeTurn()  
  }
 }
