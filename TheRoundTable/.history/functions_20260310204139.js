...
function applyMeldingStrategy( ) {
  ...
  if (window.AIMeldPlanner.shouldUnmeldAndRemeld(game.currentPlayer.hand, game.currentPlayer.meldSets, arguments,roundNumber + 2)) {
      console.log(`${game.updateCurrentPlayerReferencePlayer.name} unmelding to optimize melds`);
