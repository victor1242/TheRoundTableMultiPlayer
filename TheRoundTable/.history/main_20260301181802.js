...
// hand click
    ...
    function selectMeldCard(cardEl) {
      if (cardEl.style.border === "") {
            cardEl.style.border = "blue";
            cardEl.style.borderWidth = "9px";
            Player.meldCount += 1;
          } else {
            // deselect
            cardEl.style.border = "";
...
*/
  ...
  00if (aiAutoPlayEnabled && !aiAutoPlayPaused && game.currentPlayer && game.currentPlayer.isAI && game.roundNumber <= 11) scheduleAITurn(800);
