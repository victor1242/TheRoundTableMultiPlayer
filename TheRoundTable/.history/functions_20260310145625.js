...
function  drawDiscardHint() {
  ...
  if (shouldTakeDiscard(game.discardPile[0], game.currentPlayer.hand, game.roundNumber + 2)) showMessage("Hint: You should take the discard pile card.");
  else showMessage("Hint: You should draw a new card from the deck.");
