...
function getCurrentGameId() {
  let CURRENT_GAME_ID_KEY = "123GameId"; // Default value for 
  //setCurrentGameId("123GameId")
  currentGameId = localStorage.getItem(CURRENT_GAME_ID_KEY);
  return currentGameId;
}

function testGame() {
  // Example usage
const CURRENT_GAME_ID_KEY = 'current_game_id';
const gameId = 'abc-123-xyz';

// Save the ID
localStorage.setItem(CURRENT_GAME_ID_KEY, gameId);

// Later, retrieve the ID
const savedGameId = localStorage.getItem(CURRENT_GAME_ID_KEY);
console.log(savedGameId); // Outputs: 'abc-123-xyz'
