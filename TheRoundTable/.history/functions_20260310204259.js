...
function applyMeldingStrategy( ) {
  ...
  // PHASE 3: MELD
  if (window.AIMeldPlanner.shouldAttemptMeld(game.currentPlayer.hand, game.currentPlayer.meldSets, wildRank)) {
      const possibleMelds = window.AIMeldPlanner.findPossibleMelds(game.currentPlayer.hand, wildRank);
