...
/**
 * Server-authoritative The Round Table game state.
 *
...
class TheRoundTableGame {
  ...
  toClientState(forPlayerId) {
    ...
    if (forPlayerId && !this.playerIds.includes(forPlayerId)) {
      console.error(`[TheRoundTableGame] Warning: forPlayerId ${forPlayerId} not in this game's playerIds:`, this.playerIds);
    }
...
module.exports = { TheRoundTableGame };
