    ...
    handleDisconnect(socketId) {
      rooms.forEach((room, roomCode) => {
        ...
        if (!room.hasConnectedPlayers()) {
          // Clear any pending AI timer before removing the room
          if (pendingAutoPlay.has(roomCode)) {
            clearTimeout(pendingAutoPlay.get(roomCode));
            pendingAutoPlay.delete(roomCode);
          }
