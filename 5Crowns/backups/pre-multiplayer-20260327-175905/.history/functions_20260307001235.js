...
function saveGameState() {
  ...
  console.log(stateToSave.players[0].hand) log players hand to verify it's being saved correctly  

  console.log(stateToSave.players[1].hand)
  console.log(stateToSave.players[2].hand)
}
