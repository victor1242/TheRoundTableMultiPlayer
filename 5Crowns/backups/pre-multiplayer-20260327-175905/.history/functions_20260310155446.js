...
function  drawDiscardHint() {
  ...
  if (shouldTakeDiscardgame.discardPilegame.discardPile.length-1], game.currentPlayer.hand, game.roundNumber + 2)) updatePlayerPrompt("Hint: You should take the discard pile card.");
