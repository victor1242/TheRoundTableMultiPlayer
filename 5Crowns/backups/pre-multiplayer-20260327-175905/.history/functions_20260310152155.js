...
function  drawDiscardHint() {
  ...
  if (shouldTakeDiscard(game.discardPile[0], game.currentPlayer.hand, game.roundNumber + 2)) updatePlayerPrompt("Hint: You should take the discard pile card.");
...
function discardHint() {
  ...
  else updatePlayerPrompt("Hint: You should discard " + game.currentPlayer.hand[0].rank + "-" + game.currentPlayer.hand[0].suit);
}
