...
// hand click
    ...
    if (game.currentPlayer.melding) { 
      ...
      if (cardEl.style.border !== "")  return;
        ...
        // check if trying to discard wild card before final turn phase, if option is selected, warn player that he is discarding a wild card which the next player will probaly appreciat
