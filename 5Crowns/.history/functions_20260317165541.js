...
function Test() { 
game.deck = new Deck(game.roundNumber);
for (const card of game.deck.cards) {
...
function updateDisplay() {
  /*
    ...
    */
    ...
    if (deckCardsEl) deckCardsEl.innerText = `Deck (${game.deck.length} cards)`;
    if (discardCardsEl) discardCardsEl.innerText = `Discard Pile (${GameBoard.discardPile.lengthCount} cards)`;  
      }
