...
function  drawDiscardHint() {
  ...
  if (shouldTakeDiscard(game.discardPilegame.discardPile.l, game.currentPlayer.hand, game.roundNumber + 2)) updatePlayerPrompt("Hint: You should take the discard pile card.");
