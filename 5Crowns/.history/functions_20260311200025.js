...
function saveScoreBoard() {
  ...
  game.players.forEach((p) => {
    ...
    if (p.IsOut && game.optGoingOutBonus){
      game.currentPlayer.goingOutBonus = wildRank
      p.roundScore +=  game.currentPlayer.goingOutBonus
    }
...
// if next player is AI, trigger their turn logic
    ...
    if (game.currentPlayer.hand.length === 0) dealNewRoundCards();
