...
function ScoreBoard() {
  ...
  if (game.aiManualStepModeaiAutoPlayEnabled && !aiAutoPlayPaused && game.currentPlayer && game.currentPlayer.aiPlayer && game.roundNumber <= 11) scheduleAITurn(800);
