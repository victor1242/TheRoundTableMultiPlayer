...
function updateDisplay() {
  /*
    ...
    */
    ...
    if (deckCardsEl) deckCardsEl.innerText = `Deck (${game.deck.cards.length} cards)`;
    if (discardCardsEl) discardCardsEl.innerText = `Discard Pile (${game.discardPile.cards.length} cards)`;  
      }
