...
function displayCard(card, cardId, mode) {
  ...
  if (mode === "meld") cardImg.alt = card.rank + "-" + card.suitIcon;
  else cardImg.alt = card.rank + "-" + card.suitText;
  cardImg.width = game.cardWidth;
  cardImg.height = game.cardHeight;
  cardImg.style.border = card.styleBorder;
  if (mode === "meld") imgsrc = "./cards/" + card.rank + "_of_" + card.suitIcon + ".png";
  else imgsrc = "./cards/" + card.rank + "_of_" + card.suitText + ".png";
  cardImg.src = imgsrc;
