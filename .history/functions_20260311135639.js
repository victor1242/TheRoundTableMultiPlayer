...
// game options
let optGgoingOutBonus = true; // Bonus points for going out = cards dealt in round
let drawHint = true; // Hint to draw from deck or discard
let discardHint = true; // Hint which card to discard
let prompts = true; // Text prompts for player actions
